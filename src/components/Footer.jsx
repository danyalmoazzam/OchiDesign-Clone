...
function Footer() {
  return (
    <div className="w-full bg-zinc-100 rounded-tl-2xl rounded-tr-2xl z-10">
      <div className="grid grid-cols-2 m-10">
        <div>
          <h1 className="text-[#212121] text-[9vw] font-[FoundersGrotesk-Semibold] uppercase -mb-20">
            Eye-
          </h1>
          <h1 className="text-[#212121] text-[9vw] font-[FoundersGrotesk-Semibold] uppercase">
            Opening
          </h1>
        </div>
        ...
        <div className=" flex flex-col">
          ...
          <div className=" grid grid-cols-2 ">
            <div className=" col-span-1">
              <div className=" relative font-[NeueMontreal-Regular] ">
                <span>S:</span>
                <ul className="text-md underline mt-6">
              ...
              <div className=" relative font-[NeueMontreal-Regular] mt-5">
                <span>L:</span>
                <ul className="text-md underline mt-6 flex flex-col gap-4">
                  <li className="cursor-pointer w-48">
              ...
              <div className=" relative font-[NeueMontreal-Regular] mt-5">
                <span>E:</span>
                <ul className="text-md underline mt-3 flex flex-col gap-4">
                  <li className="cursor-pointer w-48">hello@ochi.design</li>
                </ul>
              </div>
            </div>
            <div className="col-span-1 mt-44 ml-44">
              <div className=" relative font-[NeueMontreal-Regular]  ">
                <span>M:</span>
                <ul className="text-md underline mt-6">
      ...
      <div className="logo cursor-pointer text-[#212121] p-10 flex justify-between items-center">
        <svg
          width="72"
          height="30"
          viewBox="0 0 72 30"
        ...
        <h3 className=" text-zinc-400">
          &copy; OCHI DESIGN RECREATED BY DANYAL
        </h3>
        <h3 className="font-[NeueMontreal-Regular] text-zinc-400">
          Website by DM
        </h3>
      </div>
    </div>
